...
public final class SettingControls {
    ...
    public static AbstractWidget create(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
    ...
    private static AbstractWidget createSlider(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
    ...
    private static final class SliderWidget extends AbstractSliderButton {
        ...
        private final PresetDraft target;
        private final Runnable onChanged;
        private final LogValueMapper logMapper;

        private SliderWidget(SettingDescriptor descriptor, PresetDraft target, Runnable onChanged,
     ...
     */
    private static AbstractWidget createChancePerlin(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
    ...
    private static final class PerlinChanceControl extends AbstractWidget {
        ...
        private PerlinChanceControl(SettingDescriptor d, PresetDraft target, Runnable onChanged,
    ...
    private static AbstractWidget createToggle(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
     ...
     */
    private static AbstractWidget createCycle(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
     ...
     */
    private static AbstractWidget createText(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
     ...
     */
    private static AbstractWidget createNumber(SettingDescriptor d, PresetDraft target, Runnable onChanged, int width) {
        Font font = Minecraft.getInstance().font;
