...
class PaletteExtendsTest {
    ...
    void childOverridesOnlyTheCharactersItDeclares() {
        ...
        Palette resolved = new Palette(LEAF_ID, BuiltInRegistries.BLOCK, List.of(parent, child));
    ...
    void theLastEntryInADeepChainWins() {
        ...
        assertEquals("minecraft:deepslate", blockOf(new Palette(LEAF_ID, BuiltInRegistries.BLOCK, List.of(root, middle, leaf)), 'S'));
        assertEquals("minecraft:andesite", blockOf(new Palette(LEAF_ID, BuiltInRegistries.BLOCK, List.of(root, middle)), 'S'));
    }
    ...
    void anOverriddenCharacterTakesItsDamagedMappingWithIt() {
        ...
        Palette parentOnly = new Palette(LEAF_ID, BuiltInRegistries.BLOCK, List.of(parent));
